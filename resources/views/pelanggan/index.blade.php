    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                ...
                <br>
                <a class="btn btn-success btn-block mb-4" href="/pelanggan/create">+ Tambah Data</a>
                    ...
                    <table class="table table-striped table-sm">
                        ...
                        @foreach ($pelanggans as $pelanggan)
                            <tr class="mode">
                                ...
                                <a href="{{ route('pelanggan.read', $pelanggan->id) }}" class=""><Button class="btn btn-success mb-3">Lihat</Button></a>
